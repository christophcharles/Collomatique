...
impl<SubjectId: Id> From<&collomatique_state_colloscopes::teachers::Teacher<SubjectId>>
    for Teacher
{
    fn from(value: &collomatique_state_colloscopes::teachers::Teacher<SubjectId>) -> Self {
        Teacher {
