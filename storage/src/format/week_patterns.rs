...
pub struct WeekPattern {
    pub id: u64,
    pub name: String,
    /// Positional: `weeks[w]` = pattern active on global week `w`.
    /// Must have exactly one element per week of the schedule (a
    /// referential constraint, checked at a later layer).
    pub weeks: Vec<bool>,
}
