...
CREATE TABLE balancing_global (
    ...
    avoid_twice_in_a_row_enabled INTEGER CHECK (avoid_twice_in_a_row_enabled IN (0, 1)),
    year_teacher_rotation_enabled INTEGER CHECK (year_teacher_rotation_enabled IN (0, 1)),
    period_teacher_rotation_enabled INTEGER CHECK (period_teacher_rotation_enabled IN (0, 1))
);
...
SELECT
    ...
    COALESCE(bs.avoid_twice_in_a_row_enabled, bg.avoid_twice_in_a_row_enabled) AS avoid_twice_in_a_row_enabled,
    COALESCE(bs.year_teacher_rotation_enabled, bg.year_teacher_rotation_enabled) AS year_teacher_rotation_enabled,
    COALESCE(bs.period_teacher_rotation_enabled, bg.period_teacher_rotation_enabled) AS period_teacher_rotation_enabled
FROM subjects s
