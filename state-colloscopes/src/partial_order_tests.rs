...
//!
//! These tests check the *order*, not the machinery. `state/` already owns the
//! machinery: `state/src/partial_order.rs` pins the building blocks and
//! `state/tests/derive_content_ord.rs` pins what the derive generates. What is
