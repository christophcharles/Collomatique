...
//! independently, while decoding a file, in `colloscopes/storage/src/decode/spec2.rs` — with
...
//! counterpart and a rejection test in `colloscopes/storage/tests/spec2_format.rs` in the same
