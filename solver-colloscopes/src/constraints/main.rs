...
> {
    ...
    _phantom2: std::marker::PhantomData<SlotId>,
    _phantom3: std::marker::PhantomData<GroupListId>,
    _phantom4: std::marker::PhantomData<StudentId>,
}
...
{
    pub fn new(weeks: Vec<bool>) -> Self {
...
pub enum GroupsPerSlotsDesc<SlotId: Identifier> {
    AtMostCountGroupInSlotForWeek(u32, SlotId, usize),
    AtMinimumCountGroupInSlotForWeek(u32, SlotId, usize),
}
    ...
    for GroupsPerSlots<SubjectId, SlotId, GroupListId, StudentId>
{
    ...
    type GeneralConstraintDesc = GroupsPerSlotsDesc<SlotId>;
