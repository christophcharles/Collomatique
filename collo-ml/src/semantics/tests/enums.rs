...
#[tokio::test]
async fn enum_decl_creates_types() {
    let input = r#"
...
#[tokio::test]
async fn enum_variant_is_subtype_of_root() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_variant_return_type() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_primitive_variant_names() {
    let input = r#"
...
#[tokio::test]
async fn enum_wrong_argument_type() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_wrong_argument_count() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_root_shadows_primitive_allowed() {
...
#[tokio::test]
async fn enum_match_exhaustive() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_match_non_exhaustive() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
        pub let handle(r: Result) -> Int = match r {
            x as Result::Ok { Int(x) }
...
#[tokio::test]
async fn enum_match_three_variants() {
    let input = r#"
...
#[tokio::test]
async fn qualified_type_in_maybe() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn qualified_type_in_param() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
...
#[tokio::test]
async fn enum_if_expression_unifies_to_root() {
    let input = r#"
        enum Result = Ok(Int) | Error(String);
