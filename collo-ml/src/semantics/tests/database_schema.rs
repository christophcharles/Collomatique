...
#[test]
fn database_schema_type_declaration() {
    let input = r#"
...
#[test]
fn database_schema_public_type_declaration() {
    let input = r#"
...
#[test]
fn database_schema_multiple_tables() {
    let input = r#"
...
#[test]
fn database_schema_multiple_string_literals() {
    let input = r#"
        type MultiStringDB = #{
...
#[test]
fn database_schema_identical_are_equal() {
...
#[test]
fn database_schema_identical_inline() {
    let input = r#"
...
#[test]
fn database_schema_different_not_equal() {
    let input = r#"
        type DB1 = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn database_schema_whitespace_matters() {
...
#[test]
fn database_schema_inline_in_sum_type() {
    let input = r#"
...
#[test]
fn database_schema_as_parameter() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn database_schema_inline_as_parameter() {
    let input = r#"
...
#[test]
fn database_schema_not_subtype_of_int() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn database_schema_not_subtype_of_string() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn database_schema_not_subtype_of_bool() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn int_not_subtype_of_database_schema() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn string_not_subtype_of_database_schema() {
    let input = r#"
        type MyDB = #{ "CREATE TABLE test (id INTEGER)" };
...
#[test]
fn multiple_database_schema_types() {
    let input = r#"
...
#[test]
fn cannot_mix_different_schemas() {
    let input = r#"
