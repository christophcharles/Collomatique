...
#[tokio::test]
async fn custom_type_declaration_basic() {
    let input = r#"
        type MyInt = Int;
        let f() -> MyInt = MyInt(5);
    "#;
...
#[tokio::test]
async fn custom_type_declaration_with_tuple() {
    let input = r#"
        type Point = (Int, Int);
...
#[tokio::test]
async fn custom_type_declaration_with_list() {
    let input = r#"
        type IntList = [Int];
...
#[tokio::test]
async fn custom_type_declaration_with_sum_type() {
...
#[tokio::test]
async fn custom_type_referencing_previous_custom_type() {
    let input = r#"
        type MyInt = Int;
...
#[tokio::test]
async fn into_custom_type_basic() {
    let input = r#"
        type MyInt = Int;
...
#[tokio::test]
async fn custom_type_as_parameter() {
    let input = r#"
        type MyInt = Int;
...
#[tokio::test]
async fn custom_type_as_return_type() {
    let input = r#"
        type MyInt = Int;
...
#[tokio::test]
async fn multiple_custom_types_in_function() {
    let input = r#"
        type TypeA = Int;
        type TypeB = Bool;
...
#[tokio::test]
async fn field_access_through_custom_type_with_tuple() {
    let input = r#"
        type Point = (Int, Int);
...
#[tokio::test]
async fn nested_custom_type_field_access() {
    let input = r#"
        type Point = (Int, Int);
...
#[tokio::test]
async fn error_shadowing_previous_custom_type() {
    let input = r#"
        type MyType = Int;
        type MyType = Bool;
    "#;
...
#[tokio::test]
async fn recursive_type_in_list() {
...
#[tokio::test]
async fn recursive_type_in_tuple() {
...
#[tokio::test]
async fn recursive_type_indirect_guarded() {
...
#[tokio::test]
async fn error_wrong_type_return() {
    let input = r#"
        type MyInt = Int;
        let f(x: Int) -> MyInt = x;
    "#;
...
#[tokio::test]
async fn error_wrong_type_parameter() {
    let input = r#"
        type MyInt = Int;
        let f(x: MyInt) -> Int = x;
    "#;
...
#[tokio::test]
async fn error_incompatible_custom_types() {
    let input = r#"
        type TypeA = Int;
        type TypeB = Int;
...
#[tokio::test]
async fn forall_with_custom_type() {
    let input = r#"
        type MyInt = Int;
...
#[tokio::test]
async fn error_unknown_custom_type() {
    let input = r#"
...
#[tokio::test]
async fn forward_reference_to_custom_type_now_allowed() {
...
#[tokio::test]
async fn custom_type_wrapping_union_tuple_index_same_type() {
...
#[tokio::test]
async fn custom_type_wrapping_union_tuple_index_different_types() {
...
#[tokio::test]
async fn custom_type_wrapping_union_with_triple_tuple() {
...
#[tokio::test]
async fn error_custom_type_wrapping_union_invalid_index() {
...
#[tokio::test]
async fn error_custom_type_wrapping_union_index_out_of_bounds() {
...
#[tokio::test]
async fn custom_type_wrapping_custom_type_tuple_index() {
