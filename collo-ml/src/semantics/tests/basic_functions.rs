...
#[tokio::test]
async fn string_concatenation_in_expression() {
    let input = r#"
...
#[tokio::test]
async fn sum_strings_with_expression() {
    let input = r#"
...
#[tokio::test]
async fn calling_defined_function() {
    let input = r#"
...
#[tokio::test]
async fn function_call_with_wrong_argument_count() {
    let input = r#"
        pub let helper(x: Int) -> Int = x;
...
#[tokio::test]
async fn function_call_with_wrong_argument_types() {
    let input = r#"
        pub let helper(x: Int) -> Int = x;
...
#[tokio::test]
async fn duplicate_function_definition() {
    let input = r#"
        pub let foo() -> Int = 1;
        pub let foo() -> Int = 2;
    "#;
...
#[tokio::test]
async fn recursive_function_call_should_fail() {
    let input = r#"
...
#[tokio::test]
async fn mutually_recursive_functions_now_allowed() {
