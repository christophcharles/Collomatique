...
#[tokio::test]
async fn function_with_option_param_receives_value() {
    let input = r#"
...
#[tokio::test]
async fn function_with_option_param_receives_none() {
    let input = r#"
        let process(x: ?Int) -> Int = 99;
...
#[tokio::test]
async fn function_with_option_param_passes_through_value() {
    let input = r#"
...
#[tokio::test]
async fn function_with_option_param_passes_through_none() {
    let input = r#"
        let identity(x: ?Int) -> ?Int = x;
...
#[tokio::test]
async fn function_with_multiple_option_params() {
    let input = r#"
...
#[tokio::test]
async fn function_option_list_param() {
    let input = r#"
...
#[tokio::test]
async fn function_option_list_param_receives_none() {
    let input = r#"
        let get_length(xs: ?[Int]) -> Int = 10;
...
#[tokio::test]
async fn function_with_sum_param_receives_first_variant() {
    let input = r#"
...
#[tokio::test]
async fn function_with_sum_param_receives_second_variant() {
    let input = r#"
        let process(x: Int | Bool) -> Int = 99;
...
#[tokio::test]
async fn function_with_sum_param_passes_through_first() {
    let input = r#"
...
#[tokio::test]
async fn function_with_sum_param_passes_through_second() {
    let input = r#"
        let identity(x: Int | Bool) -> Int | Bool = x;
...
#[tokio::test]
async fn function_with_three_variant_sum() {
    let input = r#"
...
#[tokio::test]
async fn function_with_sum_including_none() {
    let input = r#"
...
#[tokio::test]
async fn function_list_of_sum_param() {
    let input = r#"
...
#[tokio::test]
async fn function_sum_of_list_types_param() {
    let input = r#"
        let process(xs: [Int] | [Bool]) -> Int = 99;
...
#[tokio::test]
async fn function_option_return_returns_value() {
    let input = r#"
...
#[tokio::test]
async fn function_option_return_returns_none() {
    let input = r#"
        let maybe_value(flag: Bool) -> ?Int = if flag { 42 as ?Int } else { none };
...
#[tokio::test]
async fn function_option_list_return() {
    let input = r#"
...
#[tokio::test]
async fn function_option_list_return_none() {
    let input = r#"
        let maybe_list(flag: Bool) -> ?[Int] = if flag { [1, 2, 3] as ?[Int] } else { none };
...
#[tokio::test]
async fn function_sum_return_returns_first() {
    let input = r#"
...
#[tokio::test]
async fn function_sum_return_returns_second() {
    let input = r#"
        let choose(flag: Bool) -> Int | Bool = if flag { 42 as Int | Bool } else { true };
...
#[tokio::test]
async fn function_sum_return_with_none() {
    let input = r#"
...
#[tokio::test]
async fn function_sum_return_list_types() {
    let input = r#"
...
#[tokio::test]
async fn chained_calls_with_option_types() {
    let input = r#"
...
#[tokio::test]
async fn chained_calls_with_option_types_returns_none() {
    let input = r#"
        let first(x: Int) -> ?Int = if x > 0 { x as ?Int } else { none };
        let second(x: ?Int) -> ?Int = x;
        pub let f(x: Int) -> ?Int = second(first(x));
...
#[tokio::test]
async fn chained_calls_with_sum_types() {
    let input = r#"
...
#[tokio::test]
async fn function_returning_function_result_with_option() {
    let input = r#"
...
#[tokio::test]
async fn function_with_mixed_option_and_regular_params() {
    let input = r#"
...
#[tokio::test]
async fn function_with_mixed_sum_and_regular_params() {
    let input = r#"
...
#[tokio::test]
async fn nested_option_list_through_functions() {
    let input = r#"
...
#[tokio::test]
async fn function_sum_type_with_list_variants() {
    let input = r#"
...
#[tokio::test]
async fn realistic_optional_database_lookup() {
    let input = r#"
...
#[tokio::test]
async fn realistic_optional_database_lookup_not_found() {
    let input = r#"
        let find_by_id(id: Int) -> ?Int = if id == 1 { 100 } else { if id == 2 { 200 as ?Int } else { none } };
        let get_value(id: Int) -> ?Int = find_by_id(id);
...
#[tokio::test]
async fn realistic_polymorphic_response() {
    let input = r#"
