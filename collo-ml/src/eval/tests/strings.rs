...
#[tokio::test]
async fn concat_with_empty_string_left() {
...
#[tokio::test]
async fn concat_with_empty_string_right() {
    let input = r#"pub let f() -> String = "hello" + "";"#;
...
#[tokio::test]
async fn concat_two_empty_strings() {
...
#[tokio::test]
async fn concat_with_special_characters() {
...
#[tokio::test]
async fn concat_with_parentheses() {
...
#[tokio::test]
async fn sum_strings_with_separator() {
...
#[tokio::test]
async fn sum_empty_string_list() {
...
#[tokio::test]
async fn sum_strings_with_filter() {
...
#[tokio::test]
async fn sum_strings_with_transformation() {
...
#[tokio::test]
async fn concat_in_if_expression() {
...
#[tokio::test]
async fn concat_with_function_calls() {
    let input = r#"
...
#[tokio::test]
async fn concat_in_let_expression() {
    let input = r#"
        pub let f() -> String = 
            let prefix = "Hello" {
                prefix + ", " + "World!"
...
#[tokio::test]
async fn concat_strings_with_tildes() {
