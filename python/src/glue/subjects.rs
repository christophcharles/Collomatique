...
#[pyclass(eq, hash, frozen)]
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct ColloscopeSubjectId {
    id: collomatique_state_colloscopes::ColloscopeSubjectId,
}

#[pymethods]
impl ColloscopeSubjectId {
    fn __repr__(self_: PyRef<'_, Self>) -> Bound<'_, PyString> {
        let output = format!("{:?}", *self_);
        PyString::new(self_.py(), output.as_str())
    }
...
impl From<&collomatique_state_colloscopes::ColloscopeSubjectId> for ColloscopeSubjectId {
    fn from(value: &collomatique_state_colloscopes::ColloscopeSubjectId) -> Self {
        ColloscopeSubjectId { id: value.clone() }
    }
}

impl From<collomatique_state_colloscopes::ColloscopeSubjectId> for ColloscopeSubjectId {
    fn from(value: collomatique_state_colloscopes::ColloscopeSubjectId) -> Self {
        ColloscopeSubjectId::from(&value)
    }
}

impl From<&ColloscopeSubjectId> for collomatique_state_colloscopes::ColloscopeSubjectId {
    fn from(value: &ColloscopeSubjectId) -> Self {
        value.id.clone()
    }
}
...
impl From<ColloscopeSubjectId> for collomatique_state_colloscopes::ColloscopeSubjectId {
    fn from(value: ColloscopeSubjectId) -> Self {
        collomatique_state_colloscopes::ColloscopeSubjectId::from(&value)
    }
}
