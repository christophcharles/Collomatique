...
fn check_config_data_var_detects_missing_variables() {
    ...
    assert_eq!(report.missing_variables, BTreeSet::from([
        String::from("x21"),
        String::from("x22"),
        String::from("y11"),
        String::from("y21"),
...
fn check_config_data_var_detects_excess_variables() {
    ...
    assert_eq!(report.excess_variables, BTreeSet::from([
        String::from("z"),
        String::from("w"),
        String::from("t")
    ]));
...
fn check_config_data_var_detects_non_conforming_variables() {
    ...
    assert_eq!(report.non_conforming_variables, BTreeSet::from([
        String::from("x12"),
        String::from("x21"),
        String::from("y12")
    ]));
...
fn build_config_works_on_valid_config() {
    ...
    let config = pb.build_config(config_data)
        .expect("Config should be valid");

    assert_eq!(config.get_values(), BTreeMap::from([
        (String::from("x11"), 0.0),
        (String::from("x12"), 0.0),
        (String::from("x21"), 0.0),
        (String::from("x22"), 1.0),
