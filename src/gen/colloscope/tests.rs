...
fn group_on_slot_selection_variables() {
    ...
    let subjects = vec![Subject {
        ...
        period_is_strict: true,
        duration: NonZeroU32::new(60).unwrap(),
        slots_information: SlotsInformation {
...
fn colloscope_with_dynamic_groups() {
    ...
    let expected_result = BTreeSet::from([
        ...
        (&dga_0_0_0_2 + &dga_0_0_1_2 + &gis_1_0_0).leq(&ubipd_2),
        (&dga_0_1_0_2 + &dga_0_1_1_2 + &gis_1_1_0).leq(&ubipd_2),

        (&gis_0_0_1 + &dga_1_0_1_3).leq(&ubipd_3),
        (&gis_0_1_1 + &dga_1_1_1_3).leq(&ubipd_3),

        (&dga_0_0_0_4 + &dga_0_0_1_4 + &dga_1_0_1_4).leq(&ubipd_4),
        (&dga_0_1_0_4 + &dga_0_1_1_4 + &dga_1_1_1_4).leq(&ubipd_4),

        (&dga_0_0_0_5 + &dga_0_0_1_5 + &dga_1_0_1_5).leq(&ubipd_5),
        (&dga_0_1_0_5 + &dga_0_1_1_5 + &dga_1_1_1_5).leq(&ubipd_5),
        ...
        (&dga_0_0_0_2 + &dga_0_0_1_2 + &gis_1_0_0).leq(&ubipw_2),
        (&dga_0_1_0_2 + &dga_0_1_1_2 + &gis_1_1_0).leq(&ubipw_2),

        (&gis_0_0_1 + &dga_1_0_1_3).leq(&ubipw_3),
        (&gis_0_1_1 + &dga_1_1_1_3).leq(&ubipw_3),

        (&dga_0_0_0_4 + &dga_0_0_1_4 + &dga_1_0_1_4).leq(&ubipw_4),
        (&dga_0_1_0_4 + &dga_0_1_1_4 + &dga_1_1_1_4).leq(&ubipw_4),

        (&dga_0_0_0_5 + &dga_0_0_1_5 + &dga_1_0_1_5).leq(&ubipw_5),
        (&dga_0_1_0_5 + &dga_0_1_1_5 + &dga_1_1_1_5).leq(&ubipw_5),
        ...
        (&dga_0_0_0_2 + &dga_0_0_1_2 + &gis_1_0_0).geq(&lbipw_2),
        (&dga_0_1_0_2 + &dga_0_1_1_2 + &gis_1_1_0).geq(&lbipw_2),

        (&gis_0_0_1 + &dga_1_0_1_3).geq(&lbipw_3),
        (&gis_0_1_1 + &dga_1_1_1_3).geq(&lbipw_3),

        (&dga_0_0_0_4 + &dga_0_0_1_4 + &dga_1_0_1_4).geq(&lbipw_4),
        (&dga_0_1_0_4 + &dga_0_1_1_4 + &dga_1_1_1_4).geq(&lbipw_4),

        (&dga_0_0_0_5 + &dga_0_0_1_5 + &dga_1_0_1_5).geq(&lbipw_5),
        (&dga_0_1_0_5 + &dga_0_1_1_5 + &dga_1_1_1_5).geq(&lbipw_5),
...
fn balancing_teachers() {
    ...
    let subjects = vec![Subject {
        ...
        period_is_strict: false,
        slots_information: SlotsInformation::balance_teachers_from_slots(
            vec![
                SlotWithTeacher {
                    cost: 0,
                    teacher: 0,
...
fn balancing_timeslots() {
    ...
    let subjects = vec![Subject {
        ...
        period: NonZeroU32::new(1).unwrap(),
        period_is_strict: false,
        slots_information: SlotsInformation::balance_timeslots_from_slots(
            vec![
                SlotWithTeacher {
                    cost: 0,
                    teacher: 0,
...
fn balancing_teachers_and_timeslots() {
    ...
    let subjects = vec![Subject {
        ...
        period: NonZeroU32::new(1).unwrap(),
        period_is_strict: false,
        slots_information: SlotsInformation::balance_teachers_and_timeslots_from_slots(
            vec![
                SlotWithTeacher {
                    cost: 0,
                    teacher: 0,
