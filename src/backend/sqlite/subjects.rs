...
FROM subjects
    ...
    for record in records {
        ...
        let balancing_constraints = match record.balancing_constraints {
            ...
            5 => Ok(BalancingConstraints::OptimizeAndConsecutiveDifferentTeachers),
            6 => Ok(BalancingConstraints::OverallAndConsecutiveDifferentTeachers),
            7 => Ok(BalancingConstraints::StrictWithCutsAndConsecutiveDifferentTeachers),
            8 => Ok(BalancingConstraints::StrictWithCutsAndOverallAndConsecutiveDifferentTeachers),
...
pub async fn add(
    ...
    let balancing_constraints = match subject.balancing_requirements.constraints {
        ...
        BalancingConstraints::OptimizeAndConsecutiveDifferentTeachers => 5,
        BalancingConstraints::OverallAndConsecutiveDifferentTeachers => 6,
        BalancingConstraints::StrictWithCutsAndConsecutiveDifferentTeachers => 7,
        BalancingConstraints::StrictWithCutsAndOverallAndConsecutiveDifferentTeachers => 8,
    };
