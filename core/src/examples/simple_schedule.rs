...
//! we have a few courses (let's n of them) and a few class or student groups (let's
//! note m their number) than should attend them.
//!
//! The courses are supposed to happen all at the same time and all classes should attend
